...
console.log(arrayIdades.every((element) => element >= 18 ? 'Beba Trybeer, suave como um log de erro vazio' : 'ChocoTrybe, melhor que console.log'));
arrayIdades2.every((element) => element >= 18 ? console.log('Beba Trybeer, suave como um log de erro vazio') : console.log('ChocoTrybe, melhor que console.log'));
